...
public class PathfinderTrajectoryFollowingController extends Controller {
    double left;
    double right;
    ...
    public PathfinderTrajectoryFollowingController(double kP, double kI, double kD, double kV, double kA)
    {
