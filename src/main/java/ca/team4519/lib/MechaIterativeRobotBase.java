...
public abstract class MechaIterativeRobotBase extends RobotBase {
    ...
    private MechaIterativeRobotBase.Mode m_lastMode = MechaIterativeRobotBase.Mode.kNone;
     ...
     */
    protected MechaIterativeRobotBase(double period) {
        m_period = period;
    ...
    private boolean m_allpFirstRun = true;

    public void allPeriodic() {
        if (m_allpFirstRun) {
            System.out.println("Default testPeriodic() method... Override me!");
            m_allpFirstRun = false;
        }
    }
    ...
    protected void loopFunc() {
        ...
        if (isDisabled()) {
            ...
            // or from power-on.
            if (m_lastMode != MechaIterativeRobotBase.Mode.kDisabled) {
                LiveWindow.setEnabled(false);
                Shuffleboard.disableActuatorWidgets();
                disabledInit();
                m_watchdog.addEpoch("disabledInit()");
                m_lastMode = MechaIterativeRobotBase.Mode.kDisabled;
            }
            ...
            if (m_lastMode != MechaIterativeRobotBase.Mode.kAutonomous) {
                LiveWindow.setEnabled(false);
                Shuffleboard.disableActuatorWidgets();
                autonomousInit();
                m_watchdog.addEpoch("autonomousInit()");
                m_lastMode = MechaIterativeRobotBase.Mode.kAutonomous;
            }
            ...
            // from power-on.
            if (m_lastMode != MechaIterativeRobotBase.Mode.kTeleop) {
                LiveWindow.setEnabled(false);
                Shuffleboard.disableActuatorWidgets();
                teleopInit();
                m_watchdog.addEpoch("teleopInit()");
                m_lastMode = MechaIterativeRobotBase.Mode.kTeleop;
            }
            ...
            // power-on.
            if (m_lastMode != MechaIterativeRobotBase.Mode.kTest) {
                LiveWindow.setEnabled(true);
                Shuffleboard.enableActuatorWidgets();
                testInit();
                m_watchdog.addEpoch("testInit()");
                m_lastMode = MechaIterativeRobotBase.Mode.kTest;
            }
